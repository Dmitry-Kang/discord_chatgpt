...
async def send_message(message, user_message):
    ...
    try:
        ...
        await message.followup.send("> **Error: The openai server is overloaded or not ready yet.**")
        logger.exception(f"Error while sending message: {e}, The openai server is overloaded or not ready yet.")
